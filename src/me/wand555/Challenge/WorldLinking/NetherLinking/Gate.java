package me.wand555.Challenge.WorldLinking.NetherLinking;
...
public class Gate {
	...
	public Gate(Set<Block> frameBlocks, Set<Block> portalBlocks, Axis axis, Environment environment) {
		...
		*/
		...
		System.out.println("Newly created X: " + this.teleportTo.getBlockX() + " Y: " + this.teleportTo.getBlockY() + " Z: " + this.teleportTo.getBlockZ());
		gates.add(this);
	}
	...
	public Gate(Set<Block> frameBlocks, Set<Block> portalBlocks, Axis axis, Environment environment, Location teleportTo) {
		...
		System.out.println("TELEPORT TO: " + teleportTo.getWorld());
		System.out.println();
		gates.add(this);
	}
	...
	public Gate fromNormalToNetherAdjustment() {
		System.out.println("adjusting from normal to nether");
	...
	public Location findOrCreateAndReturnLocPortal(Gate gate, World worldTo, Location from) {
		if(Settings.spawnNearFortress) {
			if(worldTo.getEnvironment() == Environment.NETHER) {
				...
				System.out.println("FORTRESS: " + fortressLoc);
				if(fortressLoc != null) {
					...
					System.out.println("nearGate: "+nearFortressGate.getTeleportTo());
					if(nearFortressGate != null) {
						gate.setPointingTo(nearFortressGate);
						nearFortressGate.setPointingTo(gate);
						System.out.println("returned near fortress gate");
	...
	private Gate portalInRadius(Location loc, World worldTo) {
		...
		clone.setWorld(worldTo);
		System.out.println("To: " + clone.getWorld());
		System.out.println("World To: " + worldTo.getName());
